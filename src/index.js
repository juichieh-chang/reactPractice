...
ReactDOM.render(<div>
  <RowContainer objectArray={[<InputMcuObject key='mcu-1' selfClass='col-lg-3' labelName='xxx' />,
  <InputMcuObject key='mcu-2' selfClass='col-lg-4' labelClass='col-lg-3' inputClass='col-lg-9' labelName='姓名' />]} />
  <RowContainer objectArray={[<Select2McuObject key='mcu-3' selfClass='col-lg-3' labelName='測試' />,
  ...
  <CheckBoxMcuObject key='mcu-5' checkBoxClass='form-check form-check-inline col-lg-8' selfClass='col-lg-3' labelName='測試' labelClass='col-lg-3' fieldName='jjj' checkBoxValue='1' checkBoxName='O' />
  ]} />,
  <RowContainer objectArray={[<Label classNameForLable='col-lg-4' labelName='1234567890' textAlign='left' />,
  <ButtonMcuObject buttonClass='btn btn-outline-primary' buttonName='按鈕' iconClass='xxx' />]} />
</div>,
