...
ReactDOM.render(<div>
  ...
  <RadioMcuObject key='mcu-4' selfClass='col-lg-3' labelName='性別'  radioClass='col-lg-2' labelClass='col-lg-3'
    radios={[{ key: '1', 'radioName': '男', 'radioValue': '1', 'fieldName': 'gender' }, { key: '2', 'radioName': '女', 'radioValue': '2', 'fieldName': 'gender' }
    ]} />,
  <CheckBoxMcuObject key='mcu-5' checkBoxClass='form-check form-check-inline col-lg-2' selfClass='col-lg-3' labelName='測試' labelClass='col-lg-3' fieldName='jjj' checkBoxValue='1' checkBoxName='O' />
  ]} />,
